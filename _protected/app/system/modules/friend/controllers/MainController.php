...
class MainController extends Controller
{
    ...
    public function __construct()
    {
         ...
         */
        $this->view->meta_description = t("%0%'s friends. Find your soulmate with %site_name%", $this->sUsername);

        /**
         *  Predefined meta_keywords tags.
         */
        $this->view->meta_keywords = t('friends. Find your soulmate ,%0%', $this->sUsername);
    }
