...
class MainController extends Controller
{
    ...
    public function index()
    {
        ...
        $this->view->meta_description = t('friends. Find your soulmate near you with %site_name%, the new online friends. Find your soulmate  free site  new generation with webcam chat!');
        $this->view->meta_keywords = t('friends. Find your soulmate , %site_name%');
        $this->view->h1_title = t('Free Online friends. Find your soulmate  with %site_name%!');
        $this->view->h2_title = t('Innovative Online friends. Find your soulmate  Platform');
        $this->output();
    }
