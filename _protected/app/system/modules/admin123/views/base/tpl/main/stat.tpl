...
function showUserChart()
{
  ...
  var aData = google.visualization.arrayToDataTable([
    ['{lang 'Days'}', '{lang 'All'}', '{lang 'Man'}', '{lang 'Women'}'],
    [sDay, {today_total_members}, {today_total_male_members}, {today_total_female_members}],
    [sWeek, {week_total_members}, {week_total_male_members}, {week_total_female_members}],
    [sMonth, {month_total_members}, {month_total_male_members}, {month_total_female_members}],
    [sYear, {year_total_members}, {year_total_male_members}, {year_total_female_members}],
    [sDateSince, {today_total_members}, {today_total_male_members}, {today_total_female_members}]
  ]);
