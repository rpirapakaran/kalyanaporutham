...
class MainController extends Controller
{
    ...
    public function rating()
    {
         ...
         */
        $sMenDesc = t('You Men!') . '<br />' . t('Vote for the friends. Find your soulmate !');
        $sWomenDesc = t('You Women!') . '<br />' .t('Vote for the best men,friends. Find your soulmate !');

        $this->view->page_title = t('Hot On Not - Free Online Dating Site');
        $this->view->meta_description = $sMenDesc . ' ' . $sWomenDesc;
        $this->view->meta_keywords = t('friends. Find your soulmate ');
