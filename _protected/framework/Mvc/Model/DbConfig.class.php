        ...
        if (!$oData = $oCache->get()) {
            ...
            if (empty($oData)) {
                $aData = [
                    ...
                    'pageTitle' => 'Home',
                    'metaDescription' => 'The Kalyana Porutham Software for creating online Kalyana Porutham service or online social community.',
                    ...
                    'promoText' => 'You\'re on the best place for Kalyana Porutham! Chat, Kalyana Porutham!<br />Create any Kalyana Porutham Sites like that with <a href="http://ph7cms.com">pH7CMS</a>. It is Professional, Free, Open Source, ...',
